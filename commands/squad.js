                ...
                if(playerStats.userId === squad.leader[0]){
                    ...
                    if(playerStats.userId === squad.leader[0]){
                        ...
                        var squadEmbed = new Discord.MessageEmbed()
                            ...
                            .setDescription(`🪵 ${inlineCode(squad.squadName + "'s")} squad\n👑 Leader : **You**\n🪧 Squad level : ${inlineCode(numStr(Math.floor(squad.squadXp / 1000)))}\n📰 Squad Bank : ${inlineCode(numStr(squad.squadbank))} ${EMOJICONFIG.coin}\n👥 Number of Members(s): ${inlineCode(memberLenght)}\n👥 Member(s) : ${allmember}\n🗿 Squad Bosses: 💥: ${inlineCode(numStr(squad.squadboss.bossattack))} **/** ❤️: ${inlineCode(numStr(squad.squadboss.bosshealth))} **/** 🛡️: ${inlineCode(numStr(squad.squadboss.bossdefense))}`)
                            .setTimestamp();
