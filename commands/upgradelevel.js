        ...
        if (!stats) return message.reply(`${inlineCode('❌')} you are not player ! : ${inlineCode('rstart')}`);
            ...
            if(stats.player.level == 0){
                if(checkPrice(CONFIGLEVEL.level1.XPcost)){
                    ...
                    return message.reply(`❌ **${CONFIGLEVEL.level1.XPcost - balance.eco.xp}** ${EMOJICONFIG.xp} are missing`)
                }
            };
            if(stats.player.level == 1){
                if(checkPrice(CONFIGLEVEL.level2.XPcost)){
                    ...
                    return message.reply(`❌ **${CONFIGLEVEL.level2.XPcost - balance.eco.xp}** ${EMOJICONFIG.xp} are missing`)
                }
            };
            if(stats.player.level == 2){
                if(checkPrice(CONFIGLEVEL.level3.XPcost)){
                    ...
                    return message.reply(`❌ **${CONFIGLEVEL.level3.XPcost - balance.eco.xp}** ${EMOJICONFIG.xp} are missing`)
                }
            };
            if(stats.player.level == 3){
                if(checkPrice(CONFIGLEVEL.level4.XPcost)){
                    ...
                    return message.reply(`❌ **${CONFIGLEVEL.level4.XPcost - balance.eco.xp}** ${EMOJICONFIG.xp} are missing`)
                }
            };
            if(stats.player.level == 4){
                if(checkPrice(CONFIGLEVEL.level5.XPcost)){
                    ...
                    return message.reply(`❌ **${CONFIGLEVEL.level5.XPcost - balance.eco.xp}** ${EMOJICONFIG.xp} are missing`)
                }
            };
            if(stats.player.level == 5){
                if(checkPrice(CONFIGLEVEL.level6.XPcost)){
                    ...
                    return message.reply(`❌ **${CONFIGLEVEL.level6.XPcost - balance.eco.xp}** ${EMOJICONFIG.xp} are missing`)
                }
            };
            if(stats.player.level == 6){
                if(checkPrice(CONFIGLEVEL.level7.XPcost)){
                    ...
                    return message.reply(`❌ **${CONFIGLEVEL.level7.XPcost - balance.eco.xp}** ${EMOJICONFIG.xp} are missing`)
                }
            };
            if(stats.player.level == 7){
                if(checkPrice(CONFIGLEVEL.level8.XPcost)){
                    ...
                    return message.reply(`❌ **${CONFIGLEVEL.level8.XPcost - balance.eco.xp}** ${EMOJICONFIG.xp} are missing`)
                }
            };
            if(stats.player.level == 8){
                if(checkPrice(CONFIGLEVEL.level9.XPcost)){
                    ...
                    return message.reply(`❌ **${CONFIGLEVEL.level9.XPcost - balance.eco.xp}** ${EMOJICONFIG.xp} are missing`)
                }
            };
            if(stats.player.level == 9){
                if(checkPrice(CONFIGLEVEL.level10.XPcost)){
                    ...
                    return message.reply(`❌ **${CONFIGLEVEL.level10.XPcost - balance.eco.xp}** ${EMOJICONFIG.xp} are missing`)
                }
            };
            if(stats.player.level == 10){
                if(checkPrice(CONFIGLEVEL.level11.XPcost)){
                    ...
                    return message.reply(`❌ **${CONFIGLEVEL.level11.XPcost - balance.eco.xp}** ${EMOJICONFIG.xp} are missing`)
                }
            };
            if(stats.player.level == 11){
                if(checkPrice(CONFIGLEVEL.level12.XPcost)){
                    ...
                    return message.reply(`❌ **${CONFIGLEVEL.level12.XPcost - balance.eco.xp}** ${EMOJICONFIG.xp} are missing`)
                }
            };
            if(stats.player.level == 12){
                if(checkPrice(CONFIGLEVEL.level13.XPcost)){
                    ...
                    return message.reply(`❌ **${CONFIGLEVEL.level13.XPcost - balance.eco.xp}** ${EMOJICONFIG.xp} are missing`)
                }
            };
            if(stats.player.level == 13){
                if(checkPrice(CONFIGLEVEL.level14.XPcost)){
                    ...
                    return message.reply(`❌ **${CONFIGLEVEL.level14.XPcost - balance.eco.xp}** ${EMOJICONFIG.xp} are missing`)
                };
            };
            if(stats.player.level == 14){
                if(checkPrice(CONFIGLEVEL.level15.XPcost)){
                    ...
                    return message.reply(`❌ **${CONFIGLEVEL.level15.XPcost - balance.eco.xp}** ${EMOJICONFIG.xp} are missing`)
                }
            };
